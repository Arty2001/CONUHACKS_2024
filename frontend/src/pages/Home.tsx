...
function Home() {
  ...
  const [financialGoal, setfinancialGoal] = useState("H");
  ...
  const handleSubmitClick = async () => {
    ...
    try {
      const rawData = {
        ...
        expenses: {
          Rent: parseInt(rent),
          leisureActivities: parseInt(activities),
      ...
      const response = await fetch(
        "http://localhost:5000/backend/createStory",
        requestOptions
      );
        ...
        <AnimatePresence>
          {page === 0 && (
            ...
            >
              ...
              >
                <div className="button-component">OUR GOAL IS SIMPLE</div>
                <div
                  style={{
                    fontSize: 36,
                    fontWeight: "bold",
                ...
                >
                  Discover the power of [Your App Name], the all-in-one
                  financial prediction and planning app designed for
                  forward-thinking individuals. Streamline your financial
                  journey and gain a comprehensive view of your finances over
                  the years with our intuitive timeline feature
                </div>
                <div
                  style={{
                    display: "flex",
              ...
              <div style={{ width: "50%" }}>
                <img
                  src="https://safi.org/assets/images/image05.png?v=2bf77cb1"
                  width={"100%"}
                  style={{ maxHeight: "100%" }}
                />
              </div>
          ...
          {page === 1 && (
            ...
            >
              <div
                style={{
                  boxShadow:
                    " rgba(0, 0, 0, 0.04) 0px 0px 8px 0px, rgba(0, 0, 0, 0.02) 0px 0px 4px 0px, rgba(0, 0, 0, 0.04) 0px 0px 1px 1px",
                  width: "350px",
                  height: "375px",
                  display: "flex",
                  flexDirection: "column",
              ...
              >
                ...
                <div style={{ textAlign: "left", width: "100%" }}>
                  <InputLabel htmlFor="bootstrap-input">Name</InputLabel>
                </div>
                ...
                <div style={{ textAlign: "left", width: "100%" }}>
                  <InputLabel htmlFor="bootstrap-input">Age</InputLabel>
                </div>
                ...
                <BootstrapInput
                  ...
                  onBlur={(event: any) =>
                    setAnnualIncome(event.currentTarget.value)
                  }
                  style={{ margin: "8px 0px" }}
                />
              </div>
            ...
            >
              ...
              >
                ...
                <Select
                  ...
                  onChange={(event: any) =>
                    setfinancialGoal(event.target.value as string)
                  }
                  style={{
                    margin: "8px 0px",
                    width: "310px",
                    backgroundColor: "rgb(227, 246, 230)",
                  }}
                >
                  <MenuItem value={"H"}>Get My Dream House</MenuItem>
                  <MenuItem value={"PD"}>Pay off Debt</MenuItem>
                  <MenuItem value={"R"}>Retirement plan</MenuItem>
                  <MenuItem value={"I"}> Long-term Investment </MenuItem>
                </Select>
                {financialGoal === "H" && (
                  <div>
                    <div style={{ textAlign: "left", width: "100%" }}>
          ...
          {page === 3 && (
            ...
            >
              ...
              >
                <DebtsQuestionPage debts={debts} setDebts={setDebts} />
              </div>
            </motion.div>
          )}
          {page === 4 && (
            ...
            >
              ...
              >
                <AssetsQuestionPage assets={assets} setAssets={setAssets} />
              </div>
            </motion.div>
          )}
          {page === 5 && (
            ...
            >
              ...
              >
                ...
                <FormControlLabel
                  ...
                  control={
                    <Checkbox
                      checked={rentBoolean}
                      onChange={(event: any) =>
                        setRentBoolean(event.target.checked)
                      }
                    />
                  }
                />
                {rentBoolean && (
                  <div>
                    <InputLabel htmlFor="bootstrap-input">Rent</InputLabel>
                    <BootstrapInput
                      fullWidth
                      defaultValue={rent}
